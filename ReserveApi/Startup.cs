...
namespace ReserveApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPatientsContext, PatientsContext>();
            ...
            services.AddTransient<IAppointmentsContext, AppointmentsContext>();
            services.AddTransient<IAppointmentsRepository, AppointmentsRespository>();
        }
